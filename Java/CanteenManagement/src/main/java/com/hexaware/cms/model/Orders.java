 ...
 */
  ...
  public Orders(final int argCusId, final int argVenId, final int argOrderId, 
                  final WalletSource argWalletSource, final int argMenuId,
 ...
 */
  public final void setWalletSource(final WalletSource argWalletSource) {
    this.walletSource = argWalletSource;
  }
/**
 * @return this order Comments.
 */
  public final WalletSource getWalletSource() {
